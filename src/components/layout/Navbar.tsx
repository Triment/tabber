    ...
    <div data-tauri-drag-region className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6 justify-end">
      <div className="flex items-center gap-x-4 lg:gap-x-6">
        ...
        <div className="flex items-center gap-x-2">
          <button
            style={{ backgroundColor: '#ffbd44', width: '12px', height: '12px', borderRadius: '50%', border: 'none', outline: 'none' }}
            onClick={() => {
              mainWindow?.minimize();
            }}
          >
          ...
          <button
            style={{ backgroundColor: '#00ca56', width: '12px', height: '12px', borderRadius: '50%', border: 'none', outline: 'none' }}
            onClick={async () => {
          ...
          <button
            style={{ backgroundColor: '#ff6059', width: '12px', height: '12px', borderRadius: '50%', border: 'none', outline: 'none' }}
            onClick={() => {
              mainWindow?.close();
